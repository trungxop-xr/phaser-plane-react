export const LevelConfig = {
    1: { targetT95: 0, targetTowers: 0, targetInfantry: 10, targetHangars: 0, targetFlaks: 0, enemySpeedMultiplier: 1.0, spawnIntervalMultiplier: 1.0, unlockedWeapons: ['machineGun', 'bomb'], newWeaponTutorial: { name: 'Bomb ải chỉa', instruction: 'Nhấn phím 1 để ải chỉa bom nhấn lại phím 1 để dừng' } },
    2: { targetTanks: 2, targetTowers: 0, targetInfantry: 20, targetHangars: 0, targetFlaks: 0, enemySpeedMultiplier: 1.1, spawnIntervalMultiplier: 0.9, unlockedWeapons: ['machineGun', 'bomb'], newWeaponTutorial: { name: 'Súng tè le', instruction: 'giữ space để bắn tè le' } },
