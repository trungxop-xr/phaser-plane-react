export const LevelConfig = {
    1: { targetT95: 0, targetTowers: 0, targetInfantry: 10, targetHangars: 0, targetFlaks: 0, enemySpeedMultiplier: 1.0, spawnIntervalMultiplier: 1.0, unlockedWeapons: ['bomb'], newWeaponTutorial: { name: 'Bomb ải chỉa', instruction: 'Nhấn phím 1 để ải chỉa bom nhấn lại phím 1 để dừng' } },
